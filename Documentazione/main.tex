...
\subsubsection{ISP}
E' stato applicato il design principles Interface Segregation di Martin Fowler. Lo scopo di questo è di creare diverse interfacce client al posto di usarne una unica, per questo motivo si è deciso di creare diversi windows form suddividendo le responsabilità.
\subsection{Pattern}
